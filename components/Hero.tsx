		...
		<section className='relative bg-[#00122C] md:pb-20 overflow-hidden'>
			...
			<div className='relative'>
				<div className='md:flex'>
					<div className='md:w-[25%] md:pt-19'>
						<div className='flex md:mt-8 justify-center items-center h-[174px]'>
					...
					<div className='md:w-[50%] md:pt-8'>
						<h1 className='md:mt-5 text-white md:text-6xl font-plus-jakarta-sans font-bold text-center'>
							Welcome to Moon X <br /> Your Gateway to
							<br /> Decentralized learning
						</h1>
						<p className='text-white md:text-xl mt-5 tracking-tight font-plus-jakarta-sans font-normal leading-[30.24px] text-center'>
						...
						<div className='flex md:mt-7 mx-auto justify-center items-center'>
							<Link href={'/courses'}>
								<button className='py-4 text-white md:text-lg md:px-8 rounded-md bg-gradient-to-r from-[#EB7568] via-[#FAB142] to-[#FAB142]'>
									Get Started
								</button>
							</Link>
						</div>
