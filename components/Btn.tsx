...
export const BtnCancel: React.FC<Text> = ({ text, onClick }) => {
  return (
    <div>
      <button
        onClick={onClick}
        className=" text-center bg-[#FFFFFF] py-[0.5rem] px-[1rem] font-medium text-sm flex gap-2 items-center text-[#6E7485]"
      >
        {text}
      </button>
    </div>
